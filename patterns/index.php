...
<h1 class="wp-block-heading has-text-align-center">ブログ</h1>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"center","fontSize":"xs"} -->
<p class="has-text-align-center has-xs-font-size">WordPress や Web 制作、フリーランスに関することなどを公開しています。</p>
<!-- /wp:paragraph --></div></div>
<!-- /wp:cover -->

<!-- wp:query {"queryId":0,"query":{"perPage":9,"pages":0,"offset":0,"postType":"post","order":"desc","orderBy":"date","author":"","search":"","exclude":[],"sticky":"","inherit":true},"layout":{"type":"constrained"}} -->
