...
<main class="wp-block-group site-contents" style="margin-top:0"><!-- wp:cover {"url":"<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/assets/images/medicos-scaled-1.jpg","id":5622,"dimRatio":30,"isDark":false,"style":{"spacing":{"padding":{"top":"0","bottom":"0","left":"0","right":"0"},"margin":{"top":"0","bottom":"var:preset|spacing|xl"}}},"textColor":"contrast","layout":{"type":"default"}} -->
<div class="wp-block-cover is-light has-contrast-color has-text-color" style="margin-top:0;margin-bottom:var(--wp--preset--spacing--xl);padding-top:0;padding-right:0;padding-bottom:0;padding-left:0"><span aria-hidden="true" class="wp-block-cover__background has-background-dim-30 has-background-dim"></span><img class="wp-block-cover__image-background wp-image-5622" alt="" src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/assets/images/medicos-scaled-1.jpg" data-object-fit="cover"/><div class="wp-block-cover__inner-container"><!-- wp:query-title {"type":"archive","textAlign":"center"} /-->

<!-- wp:term-description {"textAlign":"center","fontSize":"xs"} /--></div></div>
<!-- /wp:cover -->
